...
parser.add_argument("-opt", type=str, default="./codes/options/test/FIB_test.yml", help="Path to options YMAL file.")
opt = option.parse(parser.parse_args().opt, is_train=False)

opt["path"]["results_root"] = "/home/chenbh/data/EDiff7"
...
for test_loader in test_loaders:
    ...
    print(f"Results will save in {dataset_dir}")
    ...
    for i, test_data in enumerate(test_loader):
        ...
        #### input dataset_LQ
        LQ, GT = test_data["LQ"], test_data["LQ"]
        LQ = util.upscale(LQ, (8, 1))
        GT = util.upscale(GT, (8, 1))
