...
if __name__ == "__main__":
    ...
    model = ConditionalNAFNet(width=64, enc_blk_nums=[14, 1, 1, 1], middle_blk_num=1, dec_blk_nums=[1, 1, 1, 1])
    inpu = torch.randn(1, 1, 256, 256)
    cond = torch.randn(1, 1, 256, 256)
    summary(model, input_data=[inpu, cond, 0.5], col_names=["mult_adds"])